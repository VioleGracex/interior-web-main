...
const ServiceCard = [
  {
    id: 1,
    title: "Роскошные условия",
    description:
      "Лорем ипсум долор сит амет, консектетуэр адиписцинг элит, Лорем ипсум долор сит амет, консектетуэр",
    icon: <FaVectorSquare />,
    link: "#",
    delay: 0.2,
  },
  ...
  },
  {
    ...
    description:
      "Лорем ипсум долор сит амет, консектетуэр Лорем ипсум долор сит амет, консектетуэр адиписцинг элит",
    ...
    <div>
      <div className="container py-20">
        ...
        <div className="space-y-2 text-center max-w-[350px] mx-auto mb-8">
          ...
          >
            Превратите ваш дом мечты в реальность с индивидуальной помощью дизайнера и тщательно подобранными продуктами.
          </motion.p>
        </div>
        {/* Карточки услуг */}
